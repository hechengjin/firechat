...
{
    skin_list<<":/skin/default"<<":/skin/green"<<":/skin/red";
...
void SkinWidget::showSkin(QString current_skin)
{
    ...
    change_skin_widget_0->changeSkin(skin_list.at(tip_index), tip_list.at(tip_index), "11"); tip_index++;
    change_skin_widget_1->changeSkin(skin_list.at(tip_index), tip_list.at(tip_index), "11"); tip_index++;
    change_skin_widget_2->changeSkin(skin_list.at(tip_index), tip_list.at(tip_index), "11"); tip_index++;
...
void SkinWidget::translateLanguage()
{
    ...
    tip_list<<tr("default")<<tr("green")<<tr("red");
}
